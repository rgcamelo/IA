...
var graficaError = new Morris.Line({
...
document.getElementById("btnIniciar")
  .addEventListener("click",function(){
    ...
    var rata = document.getElementById('rat').value
    errorDes = document.getElementById('errorDes').value
    entradas = document.getElementById('numEntradas').innerHTML
    salidas = document.getElementById('numSalidas').innerHTML
    console.log(numIteracion,rata,errorDes,entradas,salidas)
    ...
    if(numIteracion == "" ){
      ...
      alert("por favor cargue un archivo de configuracion")

    }else{
      var t=1;
      var inter;
      console.log("Inicia el entrenamiento")
      numPesos = entradas*salidas
      console.log("Pesos")
      ...
      for(var i = 0;i<salidas;i++){
        ...
        for(var j =0;j<entradas;j++){
          ...
          valores[j]=numeroAleatorioDecimales(-1,1)
        }
        pesos[i]=valores
      ...
      umbrales=[]
      for(var i=0;i<salidas;i++){
        umbrales.push(numeroAleatorioDecimales(-1,1))
      }
